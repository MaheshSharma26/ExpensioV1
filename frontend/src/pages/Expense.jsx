...
const ExpensePage = () => {
  ...
  useEffect(() => {
    ...
    fetchOverview(timeFrame);
  }, [timeFrame, customPeriod, filter, setTimeFrame, fetchOverview]);

  // Time frame range and chart points — use customPeriod when set
  ...
  // All expense transactions from raw (unfiltered) list, filtered by current period
  ...
  // Filter to the selected time frame range
  ...
  // Category and Account filter on top of time frame transactions
  ...
  const chartData = useMemo(() => {
    ...
    timeFrameTransactions.forEach(transaction => {
    ...
    return data;
  }, [timeFrameTransactions, chartPoints, timeFrame]);
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      const added = res.data?.data || res.data?.expense || res.data;
  ...
  return (
    <div className={styles.container}>
      <div className={styles.headerCard}>
        ...
        <div className={styles.timeframePositioning} style={{ gap: "20px" }}>
          <TimeFrameSelector
            timeFrame={timeFrame}
            setTimeFrame={(frame) => {
              setTimeFrame(frame);
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  border: "1.5px solid #f97316", fontSize: "0.85rem",
        ...
        <div className={styles.chartHeight}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
              ...
              />
              <Tooltip
                formatter={(value) => [`₹${Math.round(value).toLocaleString("en-IN")}`, "Expense"]}
        ...
        <div className={styles.transactionsHeader}>
          ...
          <div className="flex flex-col sm:flex-row gap-2 md:gap-3 w-full sm:w-auto">
            ...
            <div className="relative w-full sm:w-auto">
              ...
              <Filter className="absolute left-3 top-2.5 w-4 h-4 text-gray-400 pointer-events-none" style={{ left: "12px", top: "11px", position: "absolute" }} />
            </div>
